...
render5BitmapString1(465,840,"");
render5BitmapString1(470,810,"");
render5BitmapString1(480,780,"");
...
glColor3ub(232,213,212);
render5BitmapString(860,415+tmx,"Printf (' Infinity_Line ');");
...
glutCreateWindow ("A Programmer Life");
init ();
